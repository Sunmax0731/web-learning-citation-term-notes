...
- 作業ディレクトリ: `D:\AI\ChromeExtension\web-learning-citation-term-notes`
...
```powershell
cd D:\AI\ChromeExtension\web-learning-citation-term-notes
npm test
npm start
```
...
5. Chrome拡張 Side Panel + local notes の UI または配布面を開き、検証結果をユーザーが次アクションに移せる粒度で確認する。
...
- docs ZIP が `dist/web-learning-citation-term-notes-docs.zip` に存在する。
